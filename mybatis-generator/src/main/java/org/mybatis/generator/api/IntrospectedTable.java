...
public abstract class IntrospectedTable {
    ...
    protected void calculateJavaClientAttributes() {
    	JavaClientGeneratorConfiguration clientGen = context.getJavaClientGeneratorConfiguration();
        if (clientGen == null) {
            return;
        }
        ...
        if (stringHasValue(tableConfiguration.getMapperName())) {
            ...
            sb.append(fullyQualifiedTable.getDomainObjectName());
            sb.append(clientGen.getSuffix()); //$NON-NLS-1$
        }
    ...
    protected void calculateModelAttributes() {
    	JavaModelGeneratorConfiguration modelGen = context.getJavaModelGeneratorConfiguration();
