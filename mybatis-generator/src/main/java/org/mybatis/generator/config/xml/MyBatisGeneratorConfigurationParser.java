...
public class MyBatisGeneratorConfigurationParser {
    ...
    protected void parseSqlMapGenerator(Context context, Node node) {
        ...
        String suffix = attributes.getProperty("suffix", "");

        sqlMapGeneratorConfiguration.setTargetPackage(targetPackage);
        sqlMapGeneratorConfiguration.setTargetProject(targetProject);
        sqlMapGeneratorConfiguration.setSuffix(suffix);
    ...
    protected void parseJavaModelGenerator(Context context, Node node) {
        ...
        javaModelGeneratorConfiguration.setSuffix(suffix);
    ...
    private void parseJavaClientGenerator(Context context, Node node) {
        ...
        javaClientGeneratorConfiguration.setSuffix(suffix);
